...
# Based on: https://github.com/waveshareteam/e-Paper/blob/e4bb8924d47c8ac88072cdddea5544e2f4314d92/RaspberryPi_JetsonNano/python/examples/epd_7in5_V2_test.py

# python -m venv test_display_epd_7in5_V2
# source test_display_epd_7in5_V2/bin/activate
# pip install gpiozero lgpio spidev Pillow
# python -m test_display_epd_7in5_V2

import sys
import os
picdir = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'res', 'test_display_epd_7in5_V2', 'pic')
libdir = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'lib')
print(f"{libdir=} {os.path.exists(libdir)=}")
print(f"{picdir=} {os.path.exists(picdir)=}")
