# python -m venv_eink_waveshare_epd1in54
# source venv_eink_waveshare_epd1in54/bin/activate
# pip install Pillow RPi.GPIO spi spidev / pip install -r requirements_eink_waveshare_epd1in54
