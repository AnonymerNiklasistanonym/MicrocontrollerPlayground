...
print(convert_to_human_readable_str("Free file space", *df(), "MB"))
print(convert_to_human_readable_str("Free RAM space", *ramf(), "KB"))
# raspberry pi pico w:
# Free file space: 0.746/16.000 MB (4.66 %)
# Free RAM space: 179.969/185.500 KB (97.02 %)
